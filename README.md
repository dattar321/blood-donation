...
```bash
git clone https://github.com/dattar321bloodbank.git
cd bloodbank-master
```
...
See also the list of [contributors](https://github.com/dattar321bloodbank/graphs/contributors) who participated in this project.
